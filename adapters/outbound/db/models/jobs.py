# adapters/outbound/db/models/jobs.py
from uuid import uuid4, UUID as UUIDType
from sqlalchemy import Column, UUID, String, Integer, Boolean, DateTime, Text, ForeignKey, Index, SmallInteger, TIMESTAMP, func
